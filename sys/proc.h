...
/* Process created at start of EPOC or not */
#define	NEXTPROC	'f'		/* was created in the middle of epoch */
#define THISPROC	't'		/* was created in the beginning of epoch *p
...
struct	pentry	{
	...
	int	pwaitret;
	int	timequantum;		/* number of time quantums	*/
	int	counter;		/* number of time quantums used */
	int	goodnessvalue;		/* goodnessvalue for LINUX sched*/
	char	birthstatus;		/* middle or starting of epoch  */
	int	prevpreempt;		/* the preempt value when process started */
};
